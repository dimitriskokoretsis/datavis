...
This is a short summary of datavis' functionality. For a comprehensive guide aimed towards programming beginners, check the handbook [Data visualization with the datavis R package](https://github.com/dimitriskokoretsis/datavis/raw/master/guide/Data-visualization-with-the-datavis-R-package.pdf). For a full description of the datavis functions, check their [help documentation](https://github.com/dimitriskokoretsis/datavis/raw/master/guide/datavis_0.0.1.pdf).

## Why datavis

Using the datavis functions, you can easily perform the following tasks with very few lines of code:

-   Create bar/box plots with summary statistics (arithmetic or geometric mean plus/minus standard deviation), optionally including individual data points.
