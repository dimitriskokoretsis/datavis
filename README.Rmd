...
This is a short summary of `datavis`' functionality. For a comprehensive guide aimed towards programming beginners, check the handbook [Data visualization with the 'datavis' R package](https://github.com/dimitriskokoretsis/datavis/raw/master/guide/Data-visualization-with-the-datavis-R-package.pdf). For a full description of the `datavis` functions, check their help documentation in [pdf form](https://github.com/dimitriskokoretsis/datavis/raw/master/guide/datavis_0.0.1.pdf) or by browsing the package after installation.
...
-   Create bar/box plots with summary statistics:
    ...
    -   plus/minus corresponding standard deviation, or custom error measure calculated by the user
