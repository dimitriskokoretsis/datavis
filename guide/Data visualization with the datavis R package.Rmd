...
As of R version 4.2.0 (April 2022), the `|>` pipe is more flexible: it can assign its left side to any input argument of its right-side function with the `_` placeholder. The following piece of code uses `h` as the 2nd argument of `function.1` and the output of `function.1` as the 2nd input argument of `function.2`.
